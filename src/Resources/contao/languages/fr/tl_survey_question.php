...
$GLOBALS['TL_LANG']['tl_survey_question']['show'] = ['Details', 'Détails de la question ID %s'];
...
$GLOBALS['TL_LANG']['tl_survey_question']['details'] = ['Detailed statistics', 'Statistiques détaillées de la question ID %s'];

$GLOBALS['TL_LANG']['tl_survey_question']['openended'] = 'Champ libre';
...
$GLOBALS['TL_LANG']['tl_survey_question']['multiplechoice'] = 'Question à choix multiple';
...
$GLOBALS['TL_LANG']['tl_survey_question']['answered'] = 'Réponse';
